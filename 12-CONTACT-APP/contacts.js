...
const simpanContact = (nama, email, noHP) => {
    ...
    //cek nama gak boleh duplikat
    const duplikat = contacts.find((contact) => contact.nama === nama);
    if (duplikat) {
        console.log(chalk.red.inverse.bold('Contact sudah terdafar, gunakan nama lain!'));
        return false;
    }
    ...
    console.log(chalk.green.inverse.bold(`terima kasih sudah memasujan data`));
}
...
const deleteContact = (nama) => {
    ...
    console.log(chalk.green.inverse.bold(`Berhasil menghapus data contact ${nama}`));
